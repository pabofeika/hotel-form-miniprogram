...
const defaultFormTemplate = {
  ...
  "steps": [
    ...
    },
    {
      ...
      "fields": [
        {"id":7,"step_id":3,"field_key":"homepage_template","label":"主页模版选择","field_type":"select","is_required":1,"options":[{"label":"模版一","value":"template_1"},{"label":"模版二","value":"template_2"},{"label":"模版三","value":"template_3"}],"conditions":{"logic":"and","rules":[{"field":"homepage_type","operator":"in","value":["skyworth_hotel","skyworth_foot","coocaa"]}]},"sort_order":1},
        {"id":8,"step_id":3,"field_key":"room_control_type","label":"客控类型选择","field_type":"select","is_required":1,"options":[{"label":"无客控","value":"none"},{"label":"第三方客控（需要对接）","value":"third_party"},{"label":"创维自研客控","value":"skyworth_self"}],"conditions":{"logic":"and","rules":[{"field":"homepage_type","operator":"in","value":["skyworth_hotel","skyworth_foot","coocaa"]}]},"sort_order":2},
        ...
        {"id":12,"step_id":3,"field_key":"vod_method","label":"酒店点播方式","field_type":"select","is_required":1,"options":[{"label":"极光TV-商用版本","value":"aurora_tv"},{"label":"其他点播应用","value":"other"},{"label":"无点播","value":"none"}],"help_text":"建议使用极光TV商用版本","conditions":{"logic":"and","rules":[{"field":"homepage_type","operator":"in","value":["skyworth_hotel","skyworth_foot","coocaa"]}]},"sort_order":6},
