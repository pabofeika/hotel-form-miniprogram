...
const defaultFormTemplate = {
  ...
  "steps": [
    ...
    },
    {
      ...
      "fields": [
        {"id":7,"step_id":3,"field_key":"homepage_template","label":"主页模版选择","field_type":"select","is_required":1,"options":[{"label":"模版一","value":"template_1"},{"label":"模版二","value":"template_2"},{"label":"模版三","value":"template_3"},{"label":"模版四","value":"template_4"},{"label":"模版五","value":"template_5"},{"label":"模版六","value":"template_6"},{"label":"模版七","value":"template_7"}],"conditions":{"logic":"and","rules":[{"field":"homepage_type","operator":"in","value":["skyworth_hotel","skyworth_foot"]}]},"sort_order":1},
        {"id":8,"step_id":3,"field_key":"room_control_type","label":"客控类型选择","field_type":"select","is_required":1,"options":[{"label":"无客控","value":"none"},{"label":"第三方客控（需要对接）","value":"third_party"},{"label":"创维自研客控","value":"skyworth_self"}],"conditions":{"logic":"and","rules":[{"field":"homepage_type","operator":"in","value":["skyworth_hotel","skyworth_foot","third_party","coocaa"]}]},"sort_order":2},
