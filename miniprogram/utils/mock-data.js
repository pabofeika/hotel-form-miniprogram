  ...
  "steps": [
    ...
    },
    {
      ...
      "fields": [
        ...
        {"id":23,"step_id":4,"field_key":"online_mall","label":"线上商城","field_type":"multi_select","is_required":0,"options":[{"label":"智慧主页-商城","value":"smart_mall"},{"label":"第三方商城","value":"third_party"},{"label":"不使用","value":"none"}],"help_text":"电视下单需要同步采购打印机","conditions":{"logic":"and","rules":[{"field":"homepage_type","operator":"eq","value":"skyworth_hotel"}]},"sort_order":8}
      ]
    },
    {
